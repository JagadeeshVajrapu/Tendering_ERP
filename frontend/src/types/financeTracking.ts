...
export interface TenderFinancialRequirement {
  label: string;
...
export interface TenderFinancialContext {
  ...
  requirements: TenderFinancialRequirement[];
...
export interface FinanceDashboard {
  tenderId: string;
  tenderName: string;
  financialContext: TenderFinancialContext;
